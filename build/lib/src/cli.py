            ...
            if args.command == "add":
                ...
                if not entries:
                    ...
                    for entry in entries:
                        print(f"[{entry['title']}] (Strength: {entry['strength']})")
                ...
                weak_count = sum(1 for e in entries if e['strength'] == 'Weak')
                moderate_count = sum(1 for e in entries if e['strength'] == 'Moderate')
                strong_count = sum(1 for e in entries if e['strength'] == 'Strong')
                ...
                if weak_count > 0:
                    print("\nRecommendation: Update weak passwords.")
