...
from .crypto_utils import derive_key, encrypt_data, decrypt_data, calculate_entropy, estimate_strength
...
class Vault:
    ...
    def add_entry(self, title: str, secret: str, tags: List[str] = None):
        ...
        entry = {
            ...
            "strength": estimate_strength(secret)
        }
    ...
    def search_entries(self, query: str) -> List[Dict]:
        ...
        return [
            ...
            if query in e["title"].lower() or any(query in t.lower() for t in e.get("tags", []))
        ]
